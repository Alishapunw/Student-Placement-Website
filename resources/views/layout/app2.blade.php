...
<div id="mySidenav" class="slidenav" style="">
  ...
  <a href="{{ route('admin_statistics') }}" style='text-decoration:none;color:white'>Student Statistics</a>
  <a href="{{ route('admin_login') }}" style='text-decoration:none;color:white'>Logout</a>
</div>
...
<nav id="navbar">
  ...
  <div class="logo">
    ...
    <ul id="menu">
      <li><a href="{{ route('admin_statistics') }}">Student Statistics</a></li>
