         ...
         <form method="post" action="{{ route('academic_details') }}">
            ...
            <div class="form-group card shadow-lg p-3 mb-5 bg-white rounded col-md-12" style="max-width: 100%;">
               <div class="card-header">
                  <center><h1>Academic Details - <?php if($type=="DSE")
                                                         echo "DSE";
                                                         else echo "B.E."; ?></h1></center>
               </div>
            <div class="card-body">
...
@else 
                  ...
                  <div class="row">
                     ...
                     <div class="form-group col-md-3">
                        <label for="sem7_cgpa">Sem 7 CGPA</label>
                        <input type="number" class="form-control" id="sem3_cgpa" name="sem3_cgpa" value="" placeholder="Enter Sem 7 CGPA" >
                     </div>


                     <div class="form-group col-md-3">
                        <label for="sem8_cgpa">Sem 8 CGPA</label>
                        <input type="number" class="form-control" id="sem2_cgpa" name="sem4_cgpa" value="" placeholder="Enter Sem 8 CGPA" >
                     </div>
                  ...
                  <div class="row">
                     <div class="form-group col-md-4">
                        <label for="sem4_kt">Sem 4 KT</label>
                        <input type="text" class="form-control" id="sem4_kt" name="sem4_kt" value="{{ $user[0]->sem4_kt }}" placeholder="Enter Sem 4 KT">
                     </div>
                     <div class="form-group col-md-4">
                        <label for="sem5_kt">Sem 5 KT</label>
                        <input type="text" class="form-control" id="sem5_kt" name="sem5_kt" value="{{ $user[0]->sem5_kt }}" placeholder="Enter Sem 5 KT">
                     </div>
                     <div class="form-group col-md-4">
                        <label for="sem6_kt">Sem 6 KT</label>
                        <input type="text" class="form-control" id="sem6_kt" name="sem6_kt" value="{{ $user[0]->sem6_kt }}" placeholder="Enter Sem 6 KT">
                     </div>
                  </div>
                  <div class="row">
                     <div class="form-group col-md-4">
                  ...
                  <div class="row">
                     <div class="form-group col-md-12">
                        <button type="submit" class="btn btn-success shadow mb-5 rounded" id="academic_details_submit"  name="academic_details_submit" style="width: 100%;">Continue</button>
                     </div>
                  </div>
  @endif                
               </div>
